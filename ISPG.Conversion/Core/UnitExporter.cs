        ...
        private UnitExportRecord BuildUnitRecord(FamilyInstance instance, string familyName, string typeName)
        {
            ...
            return new UnitExportRecord
            {
                ...
                Classification = new UnitClassification
                {
                    ...
                    Climate = ParameterHelper.Boolish(climate.value),
                    ...
                    ClimateHeatOnly = ParameterHelper.Boolish(climateHeatOnly.value),
                    ...
                    GroundAccess = ParameterHelper.Boolish(groundAccess.value),
                    ...
                    Accessible = ParameterHelper.Boolish(accessible.value),
                    ...
                    Obstructions = ParameterHelper.Boolish(obstructions.value),
                    ...
                    StackBottom = ParameterHelper.Boolish(stackBottom.value),
