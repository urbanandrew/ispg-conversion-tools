...
namespace ISPG.Conversion.Commands.Import
{
    ...
    public class ImportUnitsCommand : IExternalCommand
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            try
            {
                ...
                using (var trans = new Transaction(doc, "Import Units"))
                {
                    trans.Start();
                ...
                TaskDialog.Show("Import Units", resultMessage);
