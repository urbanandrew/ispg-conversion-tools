...
namespace ISPG.Conversion.Commands.Import
{
    ...
    public class ImportShellCommand : IExternalCommand
    {
        // Target family/type for import (UX5_Shell)
        private const string TARGET_FAMILY_NAME = "UX5_Shell";
        private const string TARGET_TYPE_NAME = "UX5_Shell";
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            try
            {
                ...
                {
                    Title = "Select Shell Export JSON",
                ...
                using (var trans = new Transaction(doc, "Import Shell"))
                {
                    trans.Start();
                ...
                TaskDialog.Show("Import Shell", resultMessage);
